...
SRC_URI_append_rzv2ma = " \
    ...
    file://0024-drpb-proc-add-conditions-for-rzv2m.patch \
    file://0025-chage-stride-algorithm.patch \
    file://0026-change-port-definition.patch \
    file://0027-mmngr-use-cache.patch \
"
