 ...
 */
/**
 * OMXR Extension header for H.265 encoder 
 * 
 * This file contains vendor-defined extension definitions.
 *
 * \file OMXR_Extension_h265e.h
 */
#ifndef OMXR_EXTENSION_H265E_H
#define OMXR_EXTENSION_H265E_H
...
/*    Macro Definitions                                                    */
/***************************************************************************/
#define OMXR_MC_IndexVendorBaseH265Encoder     (OMXR_MC_IndexVendorBaseVideoEncoder + OMXR_MC_VendorBaseOffsetH265)		/**< base value of extended OMX_INDEXTYPE for H.265 encoder  */
#define OMXR_MC_EventVendorBaseH265Encoder     (OMXR_MC_EventVendorBaseVideoEncoder + OMXR_MC_VendorBaseOffsetH265)		/**< base value of extended OMX_EVENTTYPE for H.265 encoder  */
#define OMXR_MC_ErrorVendorBaseH265Encoder     (OMXR_MC_ErrorVendorBaseVideoEncoder + OMXR_MC_VendorBaseOffsetH265)		/**< base value of extended OMX_ERRORTYPE for H.265 encoder  */

/**
 * extended #OMX_INDEXTYPE for H.265 encoder
 */
enum {
    OMXR_MC_IndexParamVideoSequenceHeaderWithIDR     = (OMXR_MC_IndexVendorBaseH265Encoder + 0x0000),  /**< OMX.RENESAS.INDEX.PARAM.VIDEO.SEQUENCE.HEADER.WITH.IDR */
    OMXR_MC_IndexParamVideoHEVSyntaxOption           = (OMXR_MC_IndexVendorBaseH265Encoder + 0x0001),  /**< OMX.RENESAS.INDEX.PARAM.VIDEO.HEV.SYNTAX.OPTION */
    OMXR_MC_IndexParamVideoHEVVuiProperty            = (OMXR_MC_IndexVendorBaseH265Encoder + 0x0002)   /**< OMX.RENESAS.INDEX.PARAM.VIDEO.HEV.VUI.PROPERTY */
};
...
/**
 * Extended HEV Syntax Option Type.
 */
typedef struct tagOMXR_MC_VIDEO_PARAM_HEV_SYNTAX_OPTION{
    OMX_U32           nSize;            /**< size of the structure  */
    OMX_VERSIONTYPE   nVersion;         /**< OMX specification version info */
    OMX_U32           nPortIndex;       /**< target port index */
...
} OMXR_MC_VIDEO_PARAM_HEV_SYNTAX_OPTION;

/**
* Extended HEV YUI Property Type.
*/
typedef struct tagOMXR_MC_VIDEO_PARAM_HEV_VUI_PROPERTY {
    OMX_U32           nSize;                         /**< size of the structure  */
    OMX_VERSIONTYPE   nVersion;                      /**< OMX specification version info */
    OMX_U32           nPortIndex;                    /**< target port index */
...
} OMXR_MC_VIDEO_PARAM_HEV_VUI_PROPERTY;
