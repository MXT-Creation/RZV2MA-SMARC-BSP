...
/**************************************************************************
* Function Name : DRP_Check_Sem_State
* Description   : Check semaphore state.
*                 Check if the semaphore is locked for more than the time
*                 specified in the argument.
* Arguments     : time  - Threshold time [msec]
*                 sem_flag - Result for semaphore check
* Return value  : 0:OK  -1:NG
**************************************************************************/
int32_t DRP_Check_Sem_State(uint32_t time, int32_t * sem_flag);

/**************************************************************************
* Function Name : DRP_Sem_Init
* Description   : Init semaphore.
*                 If the semaphore is locked, initialize the semaphore.
*                 Be sure to execute DRP_Check_Sem_State()
*                 before executing this function.
* Arguments     : sem_flag - Result for semaphore check
* Return value  : 0:OK  -1:NG
**************************************************************************/
int32_t DRP_Sem_Init(int32_t sem_flag);
